...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertBook() {
        ...
        // Insert a new row for Prince into the provider using the ContentResolver.
        // Use the {@link BookEntry#CONTENT_URI} to indicate that we want to insert
        // into the bookts database table.
        // Receive the new content URI that will allow us to access Prince's data in the future.
